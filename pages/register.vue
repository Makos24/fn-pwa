   ...
   <div class="max-w-4xl mx-auto sm:px-6 lg:px-8"> 
    ...
    <form v-on:submit.prevent="register" class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <div class="mb-6">
            ...
            <textarea v-model="residential_address" type="text" id="residential_address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required=""></textarea>
        ...
        <div class="mb-6">
            ...
            <input v-model="password_confirmation" type="number" style="-webkit-text-security:disc;" id="confirm_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
        </div> 
        <div class="mb-6">
